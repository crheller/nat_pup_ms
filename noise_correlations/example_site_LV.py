...
#rec['resp'] = rec['resp']._modified_copy(rec['resp']._data-rec['psth']._data+rec['psth_sp']._data)
...
espec = plt.subplot2grid((2, 3), (0, 0))
pcvar = plt.subplot2grid((2, 3), (0, 1), colspan=2)
pax = plt.subplot2grid((2, 3), (1, 0), colspan=3)
