...
Xsim6, psim6 = decoding.load_FA_model(site, batch, big_psth, small_psth, sim=6, nreps=10000)
...
bb = np.var(Xsim6[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]], axis=1)
s1 = np.var(Xsim6[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]], axis=1)
...
ax[1].scatter(bb, s1, s=25)

bb = np.var(Xsim5[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]], axis=1)
s1 = np.var(Xsim5[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]], axis=1)
ax[2].scatter(bb, s1, s=25)

bb = np.var(Xsim3[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]], axis=1)
s1 = np.var(Xsim3[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]], axis=1)
ax[3].scatter(bb, s1, s=25)

bb = np.var(Xsim2[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]], axis=1)
s1 = np.var(Xsim2[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]], axis=1)
ax[4].scatter(bb, s1, s=25)

bb = np.var(Xsim4[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]], axis=1)
s1 = np.var(Xsim4[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]], axis=1)
ax[5].scatter(bb, s1, s=25)
for a in ax:
    a.plot([0, 15], [0, 15], "k--")
...
bb = np.corrcoef(Xsim6[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
s1 = np.corrcoef(Xsim6[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
...
ax[1].scatter(bb, s1, s=5)

bb = np.corrcoef(Xsim5[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
s1 = np.corrcoef(Xsim5[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
ax[2].scatter(bb, s1, s=5)

bb = np.corrcoef(Xsim3[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
s1 = np.corrcoef(Xsim3[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
ax[3].scatter(bb, s1, s=5)

bb = np.corrcoef(Xsim2[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
s1 = np.corrcoef(Xsim2[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
ax[4].scatter(bb, s1, s=5)

bb = np.corrcoef(Xsim4[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
s1 = np.corrcoef(Xsim4[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
ax[5].scatter(bb, s1, s=5)

ll = np.min(ax[0].get_xlim() + ax[0].get_ylim())
ul = np.max(ax[0].get_xlim() + ax[0].get_ylim())
for a in ax:
    a.plot([ll, ul], [ll, ul], "k--")
    # a.set_xlim((-.2, 0.5))
    # a.set_ylim((-.2, 0.5))
...
bb = np.cov(Xsim6[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
s1 = np.cov(Xsim6[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
ax[0].scatter(bb, s1, s=5)
...
s1 = np.cov(Xsim5[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
ax[2].scatter(bb, s1, s=5)

bb = np.cov(Xsim3[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
s1 = np.cov(Xsim3[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
ax[3].scatter(bb, s1, s=5)

bb = np.cov(Xsim2[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
s1 = np.cov(Xsim2[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
ax[4].scatter(bb, s1, s=5)

bb = np.cov(Xsim4[:, psim1[0, :, 0, 0]==True, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
s1 = np.cov(Xsim4[:, psim1[0, :, 0, 0]==False, stim[0], stim[1]])[np.triu_indices(X.shape[0], 1)]
ax[5].scatter(bb, s1, s=5)
